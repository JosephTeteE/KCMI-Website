...
| Prayer / counselling / welfare / celebrations / cell / service-team | Submitted on **Google Forms**, not stored by V2 public site | LINKED EXTERNAL | Verified `forms.gle` URLs from legacy services/FAQs. Google is the processor for those forms until an approved replacement phase. Care P1 Hub tables exist for future first-party intake but are **not** fed by public forms yet. |
