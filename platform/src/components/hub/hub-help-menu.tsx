  ...
  return (
    <div className="mt-6 space-y-2">
      ...
      <button
        ...
        className="inline-flex min-h-11 w-full items-center rounded-md px-3 py-2 text-left text-sm font-semibold text-[var(--color-action-primary)] hover:bg-[var(--kcmi-off-white)]"
      >
